 ...
 *  -------------------------------------------------------------
 *  -------------------------------------------------------------
 *  All modifications are followed by comment "OS_PROJ1"
 *  -------------------------------------------------------------
 *  -------------------------------------------------------------
 */
...
static void set_load_weight(struct task_struct *p)
{
	...
	/* OS_PROJ1 */
	/*
	 * SCHED_BACKGROUND task gets less than minimal weight:
	 * setting load weights and inverse weights for background scheduling
	 */
...
__setscheduler(struct rq *rq, struct task_struct *p, int policy, int prio)
{
	...
	/* OS_PROJ1 
	 * setting scheduling class to fair scheduler
	*/
...
recheck:
	...
	/* OS_PROJ1 
	 * Added eror handling cases for background scheduler
	*/
	if (policy < 0)
	...
	if (!capable(CAP_SYS_NICE)) {
		 ...
		 */
		/* OS_PROJ1 
		 * Added error handling for background scheduler.
		*/
