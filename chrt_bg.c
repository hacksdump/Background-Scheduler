...
# define SCHED_BACKGROUND 6 //Policy number for SCHED_BACKGROUND
#endif
...
int main(int argc, char *argv[])
{
	...
	while((i = getopt_long(argc, argv, "+bfphmorvV", longopts, NULL)) != -1)
	{
		...
		// introducing a -a or --background flag for running background processes.
		case 'a':
		  //printf("SCHED_BATCH not supported?\n");
